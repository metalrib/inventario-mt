...
import { Zap, ChevronDown, ChevronUp, Plus, Minus, Check, Layers } from 'lucide-react';
    ...
    <div className="bg-white rounded-2xl p-4 sm:p-5 border border-slate-200 shadow-sm">
      <div className="font-extrabold text-base text-[#1b367c] pb-3 border-b border-slate-200 flex items-center justify-between">
        <span className="flex items-center gap-2">
          ...
          <span>Registrar Retalho / Perfil</span>
        </span>
      ...
      {!isCollapsed && (
        <form onSubmit={handleSubmit} className="mt-4 space-y-4 animate-fadeIn">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3.5">
            ...
            <div>
              <div className="flex items-center justify-between mb-1">
                ...
                <button
                  ...
                  className="bg-sky-50 hover:bg-sky-100 text-sky-800 font-bold text-xs px-2 py-0.5 rounded-lg border border-sky-200 transition-colors flex items-center gap-1 cursor-pointer shadow-xs"
              ...
              <span className="text-[11px] text-slate-500 mt-1 block">
                Se deixar em branco, o ID será gerado automaticamente.
              </span>
            </div>
            ...
            <div>
              ...
              />
              <span className="text-[11px] text-slate-500 mt-1 block">
                Nome do responsável pela conferência/corte.
              </span>
            </div>
            ...
            <div>
              ...
              <button
                ...
                className="w-full h-11 bg-slate-50 hover:bg-slate-100 border-2 border-dashed border-slate-300 rounded-lg px-3 flex items-center justify-between transition-colors text-left"
              >
                <div className="flex items-center gap-2.5 min-w-0">
                  <div className="w-7 h-7 bg-white border border-slate-300 rounded-md flex items-center justify-center p-0.5 text-slate-400 shrink-0">
                    {selectedCatalogItem ? (
                      <div
                  ...
                  <div className="truncate">
                    <div className="font-extrabold text-xs text-[#1b367c] truncate">
                      {selectedCatalogItem ? selectedCatalogItem.code : 'Selecionar Perfil'}
                    </div>
                    <div className="text-[10px] text-slate-500 truncate font-medium">
                      {selectedCatalogItem ? selectedCatalogItem.desc : 'Toque para escolher'}
                    </div>
                  </div>
                </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3.5 items-end">
            ...
            <div>
              ...
              <div className="flex items-center h-11 border-2 border-slate-300 rounded-lg overflow-hidden bg-slate-50">
                <button
                  ...
                  className="w-10 h-full bg-slate-100 hover:bg-slate-200 text-slate-700 font-extrabold text-base flex items-center justify-center cursor-pointer"
                >
                  -
                </button>
                <input
            ...
            <div>
              <button
                type="submit"
                disabled={isSaving}
                className="w-full h-11 bg-[#1b367c] hover:bg-[#13275b] active:bg-blue-900 text-white font-extrabold text-sm rounded-lg transition-colors flex items-center justify-center gap-2 shadow-md disabled:opacity-50 cursor-pointer"
              >
                <Plus size={18} />
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pt-1">
            ...
            {/* Keep measure toggle */}
            <div className="flex items-center gap-2.5 p-1.5 px-3 bg-slate-50 rounded-lg border border-slate-200 self-start sm:self-auto">
